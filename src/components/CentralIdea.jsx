  ...
  return (
    <section className="bg-cream px-4 py-8">
      <div className="max-w-[860px] mx-auto">
        ...
        >
          <p className="text-[11px] font-medium uppercase tracking-[0.08em] text-gold mb-4">
            The shift
          </p>
          <h2 className="font-serif text-3xl md:text-5xl lg:text-[3rem] font-black leading-[1.1] tracking-tight text-ink max-w-[620px] mx-auto">
            Every employee{" "}
            <em className="font-serif italic font-black text-gold">should think like a builder.</em>
          </h2>

          <blockquote className="mt-10 border-l-2 border-gold pl-6 max-w-[600px] mx-auto text-left">
